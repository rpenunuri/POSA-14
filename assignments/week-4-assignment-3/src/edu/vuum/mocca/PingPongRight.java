...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private final SimpleSemaphore mSimpleSemaphore[] = new SimpleSemaphore[2];
        /**
    ...
    public static void process(String startString, 
        ...
        // constructor call.
        mLatch = new CountDownLatch(2); // null;

        // Create the ping and pong SimpleSemaphores that control
        // alternation between threads.

        // TODO - You fill in here, make pingSema start out unlocked.
        SimpleSemaphore pingSema = new SimpleSemaphore(1, true);// null;
